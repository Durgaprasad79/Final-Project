...
GPS coordinates to human-readable addresses. Focused on Vijayawada,
Andhra Pradesh, India region.
"""
...
class GeocodeService:
    ...
    def __init__(self):
        ...
        self.geocoder = Nominatim(
            user_agent="civic_complaint_system_Vijayawada_v1.0",
            timeout=10
        )
        ...
        while retry_count < max_retries:
            try:
                ...
                result = {
                    ...
                    'city': address.get('city', 'Vijayawada'),
    ...
    def _extract_area(self, address: Dict) -> str:
        ...
        return address.get('city', 'Vijayawada')
